...
function loadDatable(){
    $('#dataTable').DataTable({
        ...
        "columns": [
             ...
             { "data": "id",
                "render": function(data, type, row, meta) {
                    return '<a class="btn btn-primary btn-xs" data-id="'+data+'" id="viewMapButton" type="button" data-toggle="modal" data-target="#vendorChoiceModal"><i class="fas fa-link"></i></a>';
                }
             },
             { "data": "is_processable" ,
                "defaultContent": "",
